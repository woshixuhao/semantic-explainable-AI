...
def val_distribution(conv_out, reshape_num):
    ...
    np.save('result_save/dog_space_3000.npy', cat_space)
    np.save('result_save/dog_space_3000_pic.npy', cat_space_pic)
    return cat_space,cat_space_pic
...
def plot_distribution(space_index,space_value,picture='big'):
    ...
    space = np.load(f'result_save/{config.position_animal}_space_3000.npy')
    space_pic = np.load(f'result_save/{config.position_animal}_space_3000_pic.npy')
